...
##
## @brief      Controls the data flow from CustomerModel to Menu
##
class CustomerController
	...
	##
	## @brief      selects a customer out of all customers
	##
	## @param      customers  The customers
	##
	## @return     set customer method
	##
	...
	##
	## @brief      sets the customer
	##
	## @param      cid        The cid
	## @param      customers  The customers
	##
	## @return     customerId if the customer exists or the message 'Customer Does Not Exist' if customer does not exist
	##
